...
import org.andengine.util.algorithm.path.astar.tile.IForcedStop;
 ...
 */
public class AStarPathTileModifierSimple extends EntityModifier implements IForcedStop {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	private AStarPathTileSequenceListenerSimple mAStarPathTileSequenceListner;
	...
	// Constructors
	// ===========================================================
	public AStarPathTileModifierSimple(final float pDuration, final Path pPath, final int[] pTileDimensions,
	...
	public AStarPathTileModifierSimple(final float pDuration, final Path pPath, final int[] pTileDimensions,
		...
		for (int i = 0; i < this.modifierCount; i++) {
			if (this.mIsometric) {
				...
				*/
				...
				this.moveModifiers[i] = new MoveModifier(duration, tileCen[0], tileCenNeigbour[0], tileCen[1],
						tileCenNeigbour[1]);
			} else {
		...
		this.mAStarPathTileSequenceListner = new AStarPathTileSequenceListenerSimple(this.mPathModifierListener,
				this.moveModifiers, pPath, true, pEntityModifier);
	...
	protected AStarPathTileModifierSimple(final AStarPathTileModifierSimple pPathModifier) throws DeepCopyNotSupportedException {
	...
	@Override
	public AStarPathTileModifierSimple deepCopy() throws DeepCopyNotSupportedException {
		return new AStarPathTileModifierSimple(this);
	}
