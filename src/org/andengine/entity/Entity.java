...
public class Entity implements IEntity {
	...
	public void setMask(Rect pR) {
		...
		setPosition(mMask.getX(), mMask.getY());
		setSize(mMask.getWidth(), mMask.getHeight());
	}
	...
	private void managedDraw(GLState pGLState, Camera pCamera) {
