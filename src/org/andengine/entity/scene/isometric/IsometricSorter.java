...
public class IsometricSorter {
	...
	public IsometricSorter(final int pMapWidth, final int pMapHeight, final int pDivider) {
		this.mMapWidth = pMapWidth;
		this.mMapHeight = pMapHeight;
